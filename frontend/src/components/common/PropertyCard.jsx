...
import { HiShieldCheck, HiHeart, HiOutlineHeart, HiLocationMarker, HiOutlineHome, HiArrowsExpand, HiOutlineUserGroup, HiEye } from "react-icons/hi";
...
const PropertyCard = ({
    ...
    return (
        <div className={s.card}>
            <Link to={`/properties/${property._id}`} className={s.link}>
                ...
                <div className={s.content}>
                    ...
                    {/* view detail action - always visible */}
