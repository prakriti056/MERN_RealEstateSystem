...
import { HiOutlineChartBar, HiOutlineClipboardList, HiOutlineLogout, HiOutlineUser, HiOutlineViewGrid } from "react-icons/hi";
...
const SellerSidebar = ({isOpen, onClose}) => {
    ...
    return (
        <>
        {/* Backdrop - separate element, not wrapping the sidebar */}
        <div
