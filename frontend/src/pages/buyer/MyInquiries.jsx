...
const MyInquiries = () => {
    ...
    // to fetch the inquiry comingfrom server side
    useEffect(() => {
        const featchInquiries = async () => {
            if (!user) return;
            try {
            ...
            >
                <div className={s.mb12}>
                    ...
                    <p className={s.textMuted}>
                        {isSeller
                            ? "Review and respond to intrest in your properties"
                        ...
                        {inquiries.length === 0 ? (
                            <div className={s.cardPremiumPy24Px8TextCenter}>
                                ...
                                <p className={s.textMutedMb8}>
                                    {isSeller 
                                    ? "You haven't and inquiries yet. Better listings get more attention!"
                                ...
                                {inquiries.map((inq) => (
                                    <div key={inq._id} className={s.inquiryCard}>
                                        ...
                                        <div className={s.actions}>
                                                ...
                                                {isSeller && !inq.isRead && (
                                                    <button onClick={() => markAsReader(inq._id)}
