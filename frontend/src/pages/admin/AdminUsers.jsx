...
import { HiOutlineFilter, HiOutlineIdentification, HiOutlineLocationMarker, HiOutlineLockClosed, HiOutlineLockOpen, HiOutlineMail, HiOutlineTrash } from "react-icons/hi";
                            ...
                            {filteredUsers.length > 0 ? (
                                        ...
                                        <td className={s.tdStatus}>
                                            {user.isBlocked ? (
                                                ...
                                                <span className={s.statusBadgeActive}>
                                                    <HiOutlineLocationMarker size={14} /> Active
                                                </span>
                                            )}
                                ...
                                <tr>
                                    <td className={s.emptyState} colSpan="5">
                                        No users found forr this filter.
                                    </td>
                                </tr>
                            )}
                        </tbody>
