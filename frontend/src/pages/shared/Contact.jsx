...
const Contact = () => {
    ...
    // to submit the data ro serve side
            ...
            <div className={s.mainContainer}>
                <div className={s.header}>
                    ...
                    <p className={s.subheading}>
                        Have questions or feedback? We'd love to hear from you. Our team is hare to help you with anything you need.
                    </p>
                </div>
                        ...
                        <div className={s.contactInfoCard}>
                            <div className={`${s.contactItem} ${s.contactItemMarginBottom
                                ...
                                <div>
                                    ...
                                    <div className={s.contactDetail}>Suppoort@realestate.com</div>
                                </div>
                            </div>
