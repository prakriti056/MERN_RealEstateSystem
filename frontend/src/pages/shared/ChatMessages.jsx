...
import { HiOutlineChatAlt2, HiOutlineTrash, HiChevronLeft, HiPaperAirplane } from 'react-icons/hi';
...
const ChatMessages = () => {
    ...
    //updateing the chat when new message is received
    ...
    return (
        <div
            className={`${s.chatContainer} ${user?.role === "seller"
                                ...
                                >
                                    <div className={s.avatar}>
                                        {getChatPartner(chat)?.profilePic ? (
                                            <img src={getChatPartner(chat).profilePic} className={s.activeImg} alt="" />
                                        ) : (
