...
import { HiChevronLeft, HiChevronRight, HiHeart, HiLocationMarker, HiOutlineHeart, HiX, HiOutlineHome, HiOutlineUserGroup, HiCollection, HiOutlineViewGrid, HiCalendar, HiPhotograph, HiBadgeCheck,HiChatAlt } from "react-icons/hi";
          ...
          {property.images && property.images.length > 0 ? (
            ...
            >
              ...
              {property.images.slice(1, 5).map((img, idx) => (
                ...
                >
                  <img src={img} alt={`view ${idx + 1}`} className={s.galleryImage} />
            ...
            <div className="bg-[#f1f5f9] rounded-3xl flex flex-col items-center justify-center h-[300px] md:h-[400px] text-[#94a3b8] gap-4">
              <HiPhotograph size={48} />
              <span className="text-lg font-semibold">No images available</span>
              <span className="text-sm">Images will appear here once uploaded</span>
            </div>
          )}
            ...
            <div className={s.mobileSliderContainer}>
              <div className={s.mobileSliderTrack}>
                {property.images.map((img, idx) => (
                  ...
                  >
                    <img src={img} alt={`slide ${idx + 1}`} className={s.mobileSlideImage} />
              ...
              {property.status?.toLowerCase() === "rent" && (
                <div className={s.rentDetails}>
                  <div className={s.rentDetailRow}>
                    ...
                    ₹
                    {Number(property.securrityDeposit || 0).toLocaleString(
                      "en-IN",
                    )}
                    </span>
                    </div>
