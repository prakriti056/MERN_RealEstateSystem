                        ...
                        <div className={s.contentGroupLarge}>
                            <div>
                                ...
                                <input
                                    ...
                                    placeholder="e.g. Luxury 38HK Apartment in Downtown"
                                    className={s.input}
                                    required
                                />
                            </div>
                    ...
                    <div className={s.twoColumnGrid}>
                        ...
                        <div>
                            ...
                            <div className={s.contentGroupSmall}>
                                <div>
                                    <label className={s.labelSmallMargin}>Price (रु)</label>
                                    <input
                                        type="number"
                                        name="price"
                                ...
                                <div className={s.gridTwoCol}>
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="pincode" value={formData.pincode}
                                            onChange={handleInputChange} placeholder="e.g. 40000001"
                                            className={s.input} required />
                                    </div>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="area" value={formData.area}
                                        onChange={handleInputChange} placeholder="e.g. Durbar Marg"
                                        className={s.input} required />
                                </div>
                            </div>
                        </div>
                        ...
                        <div className={s.amenitiesGrid}>
                            {commonAmenities.map((amenity) => (
                                ...
                                `}>
                                    ...
                                    />
                                    <span
                                        className={`${s.amenityTextBase} ${formData.amenities.includes(amenity)
                                                ? s.amenityTextActive
