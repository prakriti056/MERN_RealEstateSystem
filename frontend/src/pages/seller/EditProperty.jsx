...
const EditProperty = () => {
    ...
    const removeExistingImage = (url) => {
        setExistingImages(existingImages.filter((existingUrl) => existingUrl !== url));
    };
            ...
            <div className={s.innerContainer}>
                <div className={s.headerWrapper}>
                    ...
                    <p className={s.pageSubtitle}>
                        Upadte your property details and manage images.
                    </p>
                </div>
                        ...
                        <div className={s.amenitiesGrid}>
                            {commonAmenities.map((amenity) => (
                                ...
                                >
                                    ...
                                    <input
                                        type="checkbox" checked={formData.amenities.includes(amenity)}
